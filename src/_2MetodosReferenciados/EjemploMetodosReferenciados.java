package _2MetodosReferenciados;
...
public class EjemploMetodosReferenciados {
    ...
    public static void main(String[] args) {
        ...
        //La interfaz Function<T,R>  recibe un argumento de tipo T y retorna un resultado de tipo R
        //es decir en la siguiente linea: va a recibir un String y va a devolver un Integer que va a ser la longitud de la cadena que se le envie
